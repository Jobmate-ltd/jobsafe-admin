// JobSafe Admin Dashboard — sample data for a UK transport operator
// Depots: Wolverhampton, Birmingham, Bristol, Leeds, Glasgow
...
const KPI = {
  openHighSeverity: { value: 7, label: 'Open high-severity', sub: 'Requires immediate attention', spark: [3,4,5,5,6,7,7], delta: '+2 vs 7d ago' },
  overdueActions:   { value: 3, label: 'Overdue actions',    sub: '2 assigned to you',            spark: [1,1,2,2,3,3,3], delta: 'Oldest: 4 days' },
  thisWeek:         { value: 18, label: 'Incidents this week', sub: 'vs 16 last week',            spark: [2,4,3,5,1,2,1], delta: '+12.5%', up: true },
  daysSinceLTI:     { value: 47, label: 'Days since last LTI', sub: 'Last: 14/05/26 · Wolverhampton', spark: null, delta: 'Best: 89 days' },
};
...
// Site breakdown — stacked: [HSSE, NearMiss, Incident, Other]
const SITES = [
...
// 12 weeks of category-level counts, oldest → newest. Week 12 = this week.
const TREND_12W = {
...
// Annotations: high-severity events on the trend line (weekIndex, label)
const TREND_ANNOTATIONS = [
  { week: 3,  label: 'LTI — Wolverhampton' },
  { week: 7,  label: 'Forklift collision — Bristol' },
  { week: 11, label: 'Diesel spill — Wolverhampton' },
];

// Category totals + delta vs previous 30 days
const CATEGORY_30D = [
...
Object.assign(window, { CATEGORIES, SEVERITY, STATUS, KPI, INCIDENTS, SITES, TREND_12W, TREND_ANNOTATIONS, CATEGORY_30D });
